...
@Autonomous(name = "AutoRedPlayoff")
public class AutoRedPlayoff extends OpMode {
    ...
    private final Pose _angle1Pose = new Pose(94, 15, Math.toRadians(0));
    private final Pose _pickup1Pose = new Pose(115, 10, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose _pickup2Pose = new Pose(122, 10, Math.toRadians(0));
    private final Pose _pickup3Pose = new Pose(129, 10, Math.toRadians(0));
