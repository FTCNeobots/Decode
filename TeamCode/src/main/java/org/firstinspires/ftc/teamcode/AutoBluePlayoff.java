...
@Autonomous(name = "AutoBluePlayoff")
public class AutoBluePlayoff extends OpMode {
    ...
    private final Pose _angle1Pose = new Pose(50, 15, Math.toRadians(180));
    private final Pose _pickup1Pose = new Pose(30, 10, Math.toRadians(180)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose _pickup2Pose = new Pose(23, 10, Math.toRadians(180));
    private final Pose _pickup3Pose = new Pose(15, 10, Math.toRadians(180));
